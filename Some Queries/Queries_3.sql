...
junto con el total de horas trabajadas y un ranking de empleados dentro de su departamento basado en las horas trabajadas.

Funciones de Ventana: Utiliza la función de ventana RANK() para asignar un ranking a cada empleado en función de las horas trabajadas, 
...
FROM 
	empleados AS e
INNER JOIN 
	asignacionesdeproyectos AS a ON a.empleado_id = e.empleado_id
GROUP BY 
